    ...
    <>
      ...
      <section className="bg-teal py-20 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-cream/60 max-w-md text-[15px] leading-relaxed mx-auto">
            Find us at restaurants and breweries across Toronto.
            Pre-order to guarantee your cheesesteak.
          </p>
          <p className="font-display text-4xl md:text-5xl font-bold text-white mt-8">
            Check back soon!
          </p>
        </div>
      </section>
      ...
      {/* Events List */}
      {!!events?.length && <section className="py-20 md:py-28 bg-cream">
