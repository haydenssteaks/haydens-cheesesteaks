  ...
  return (
    <footer className="bg-teal text-cream">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-10 border-b border-cream/10">
          {/* Brand */}
          <div>
            <Image
              src="/logo-full.png"
            ...
            />
            <p className="text-cream/60 text-sm italic font-display mb-3">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 text-cream/70 hover:text-cream transition-colors duration-200 text-sm group"
            >
        ...
        <div className="pt-6 text-center">
          <p className="text-cream/30 text-xs">
            &copy; {new Date().getFullYear()} Hayden&apos;s Authentic Cheesesteaks. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
